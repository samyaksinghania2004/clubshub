...
USE_X_FORWARDED_HOST = env_bool("CLUBSHUB_USE_X_FORWARDED_HOST", True)
if env_bool("CLUBSHUB_TRUST_X_FORWARDED_PROTO", True):
...
MIDDLEWARE = [
    ...
    "core.middleware.SensitivePageCacheMiddleware",
...
SESSION_COOKIE_SECURE = env_bool("CLUBSHUB_SESSION_COOKIE_SECURE", False)
CSRF_COOKIE_HTTPONLY = False
CSRF_COOKIE_SECURE = env_bool("CLUBSHUB_CSRF_COOKIE_SECURE", False)
