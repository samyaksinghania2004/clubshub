...
urlpatterns = [
    ...
    path("<uuid:pk>/channels/create/", views.club_channel_create_view, name="club_channel_create"),
    path(
        "<uuid:pk>/channels/<slug:slug>/members/add/",
        views.club_channel_add_member_view,
        name="club_channel_add_member",
    ),
    path(
        "<uuid:pk>/channels/<slug:slug>/members/<int:user_id>/remove/",
        views.club_channel_remove_member_view,
        name="club_channel_remove_member",
    ),
    path(
        "<uuid:pk>/channels/<slug:slug>/delete/",
    ...
    path(
        "<uuid:pk>/members/<int:user_id>/remove/",
